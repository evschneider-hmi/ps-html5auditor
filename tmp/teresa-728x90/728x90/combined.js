...
let animate = function () {
  ...
  tl.add("frame1", 0.5);
  // in
  tl.to($frame1_eyebrow_in, { duration: 0.5, left: '-16px' }, "frame1");
  tl.to($frame1_teresa_in, { duration: 0.5, left: '375px' }, "frame1");
  tl.to($frame1_copy_in, { duration: 0.5, left: '218px' }, "frame1");
  ...
  // in
  tl.to($frame3_eyebrow_in, { duration: 0.5, left: '-15px' }, "frame3");
  tl.to($frame3_copy_in, { duration: 0.5, left: '181px' }, "frame3");
  tl.to($frame3_cta_in, { duration: 0.5, left: '226px' }, "frame3");
  tl.to($frame3_logo_in, { duration: 0.5, left: '0' }, "frame3");
  tl.to($frame3_teresa_in, { duration: 0.5, left: '375px' }, "frame3");
